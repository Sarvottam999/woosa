...
Social links are rendered on the `/about` page and in the footer based on the array configured in the `social` object. You can set custom icons to each, but don't forget to import them in `src/once-ui/icons.ts`. Read the woosa documentation](https://once-ui.com/docs/icons) for more information.
...
`const home = {
    label: "Home",
    title: "Woosa's Portfolio",
    description: "Portfolio website showcasing my work as a Design Engineer",
    headline: <>Design engineer and builder</>,
    subline: (
      <>
        I'm woosa, a design engineer at <InlineCode>FLY</InlineCode>, where I craft intuitive
