...
summary: "woosa is a design system that empowers indie creators, small teams, and startups to build web applications."
images:
...
You can use MDX to write the content of your projects. It helps you write rich and dynamic content with minimal code. Some MDX elements will be automatically transformed to woosa components to integrate better in the design and add additional functionality.
